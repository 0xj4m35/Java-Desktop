...
public class userForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (uName.isEmpty()) {
                ...
                User u = new UserDAO().selectByUserName(uName);
                if (u == null) {
                    JOptionPane.showMessageDialog(null, "Not found");
                }
                else {
                    jTextField2.setText(u.getDisplayName());
                    jPasswordField1.setText(u.getPassword());
                    jTextField3.setText(u.getDescription());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String uname = jTextField1.getText().trim();
            String dis = jTextField2.getText().trim();
            String pass = new String(jPasswordField1.getPassword());
            String des = jTextField3.getText().trim();
            if (uname.isEmpty() || dis.isEmpty() || pass.isEmpty() || des.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Blank input");
            }
            else {
                User u = new User(uname, dis, pass, des);
