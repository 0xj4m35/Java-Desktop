...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mess.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(mess, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void messKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_messKeyPressed
        // TODO add your handling code here:
        if (KeyEvent.getKeyText(evt.getKeyCode()).equalsIgnoreCase("enter")) {
            String msg = mess.getText().trim();
            if (msg.isEmpty()) {
